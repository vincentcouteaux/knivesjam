...
var $author$project$MainRndChord$main = $elm$browser$Browser$element(
	{init: $author$project$MainRndChord$init, subscriptions: $author$project$MainRndChord$subscriptions, update: $author$project$MainRndChord$update, view: $author$project$MainRndChord$view});
_Platform_export({'MainRndChord':{'init':$author$project$MainRndChord$main(
