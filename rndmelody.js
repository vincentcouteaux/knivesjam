...
var $author$project$RndMelody$SequenceGenerated = function (a) {
					...
					$elm$core$List$indexedMap(
						F2(
							function (id_, pitch) {
								...
								return _List_fromArray(
									[
										A5($author$project$Tune$Event, id, true, pitch, 'piano', 1),
										A5($author$project$Tune$Event, id + 0.9, false, pitch, 'piano', 1)
									]);
							})),
...
var $author$project$RndMelody$subscriptions = function (model) {
	return $author$project$Tune$sequenceFinished(
...
var $author$project$RndMelody$toggleSet = F2(
	function (c, s) {
		return A2($elm$core$Set$member, c, s) ? A2($elm$core$Set$remove, c, s) : A2($elm$core$Set$insert, c, s);
	});
var $author$project$RndMelody$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SetBpm':
				var b = msg.a;
					...
					model.playing ? $elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Tune$pause(_Utils_Tuple0),
								$author$project$Tune$setCursor(0)
							])) : $author$project$Tune$play(_Utils_Tuple0));
...
var $author$project$RndMelody$TogglePlay = {$: 'TogglePlay'};
...
var $author$project$RndMelody$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$RndMelody$TogglePlay)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
				...
				_List_fromArray(
					[
						A3(
						$author$project$RndMelody$togBtn,
						'unison',
						A2($elm$core$Set$member, 0, model.intervals),
						$author$project$RndMelody$ToggleInterval(0)),
						A3(
						$author$project$RndMelody$togBtn,
						'2nd m',
						A2($elm$core$Set$member, 1, model.intervals),
						$author$project$RndMelody$ToggleInterval(1)),
						A3(
						$author$project$RndMelody$togBtn,
						'2nd M',
						A2($elm$core$Set$member, 2, model.intervals),
						$author$project$RndMelody$ToggleInterval(2)),
						A3(
						$author$project$RndMelody$togBtn,
						'3rd m',
						A2($elm$core$Set$member, 3, model.intervals),
						$author$project$RndMelody$ToggleInterval(3)),
						A3(
						$author$project$RndMelody$togBtn,
						'3rd M',
						A2($elm$core$Set$member, 4, model.intervals),
						$author$project$RndMelody$ToggleInterval(4)),
						A3(
						$author$project$RndMelody$togBtn,
						'4th',
						A2($elm$core$Set$member, 5, model.intervals),
						$author$project$RndMelody$ToggleInterval(5)),
						A3(
						$author$project$RndMelody$togBtn,
						'tritone',
						A2($elm$core$Set$member, 6, model.intervals),
						$author$project$RndMelody$ToggleInterval(6)),
						A3(
						$author$project$RndMelody$togBtn,
						'5th',
						A2($elm$core$Set$member, 7, model.intervals),
						$author$project$RndMelody$ToggleInterval(7)),
						A3(
						$author$project$RndMelody$togBtn,
						'6th m',
						A2($elm$core$Set$member, 8, model.intervals),
						$author$project$RndMelody$ToggleInterval(8)),
						A3(
						$author$project$RndMelody$togBtn,
						'6th M',
						A2($elm$core$Set$member, 9, model.intervals),
						$author$project$RndMelody$ToggleInterval(9)),
						A3(
						$author$project$RndMelody$togBtn,
						'7th m',
						A2($elm$core$Set$member, 10, model.intervals),
						$author$project$RndMelody$ToggleInterval(10)),
						A3(
						$author$project$RndMelody$togBtn,
						'7th M',
						A2($elm$core$Set$member, 11, model.intervals),
						$author$project$RndMelody$ToggleInterval(11)),
						A3(
						$author$project$RndMelody$togBtn,
						'8th',
...
var $author$project$RndMelody$main = $elm$browser$Browser$element(
	{init: $author$project$RndMelody$init, subscriptions: $author$project$RndMelody$subscriptions, update: $author$project$RndMelody$update, view: $author$project$RndMelody$view});
_Platform_export({'RndMelody':{'init':$author$project$RndMelody$main(
